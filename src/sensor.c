...
static int32_t read_pressure(const uint8_t *sensor_buffer);
static float read_pressure_f(const uint8_t *sensor_buffer);
...
static int32_t read_pressure(const uint8_t *sensor_buffer)
{
    ...
    int32_t pressure = ((uint32_t)sensor_buffer[1] << 16) |
...
static float read_pressure_f(const uint8_t *sensor_buffer) {
    return (float)read_pressure(sensor_buffer) / (float)6400.0;
}

static int32_t read_altitude(const uint8_t *sensor_buffer) {
    int32_t alt = ((uint32_t)sensor_buffer[1] << 24) |
                  ((uint32_t)sensor_buffer[2] << 16) |
                  ((uint32_t)sensor_buffer[3] << 8);
...
static uint16_t read_temperature(const uint8_t *sensor_buffer)
{
    return ((uint16_t)sensor_buffer[4] << 8) |
           ((uint16_t)sensor_buffer[5]);
}
